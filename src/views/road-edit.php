...
<div class="w-full h-full p-4">
  <div class="w-full h-full relative border-2 border-slate-500/50 shadow-md rounded-lg overflow-hidden">
    ...
    <div class="absolute bottom-4 right-3" x-on:click="window.resetZoom()">
      <svg xmlns="http://www.w3.org/2000/svg" class="size-7 cursor-pointer" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
